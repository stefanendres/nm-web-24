...
export let collections = (document.querySelector('.collection')) ? Array.prototype.map.call(document.querySelectorAll('.collection'), function (item) {
  return {
    el: item,
    swiper: undefined,
    swiperWr: item.querySelector('.swiper-wrapper'),
    d: {
      cW: undefined //contentWidth
    }
  }
}) : undefined